...
class _AddTask extends StatefulWidget {
  _AddTask({this.mainContext, this.posBefore = -1, this.parentId});
...
class __AddTaskState extends State<_AddTask> {
  ...
  Widget build(BuildContext context) {
    var posBefore = widget.posBefore;
...
void showAddTaskPanel(BuildContext context,
    {int posBefore = -1, int parentId}) {
  final mainContext = context;
  showModalBottomSheetCustom(
    settings: RouteSettings(name: '/add_task'),
    context: context,
...
//temporary solution
//wait for Flutter update
//[#60640](https://github.com/flutter/flutter/pull/60640)
const Duration _bottomSheetEnterDuration = Duration(milliseconds: 250);
const Duration _bottomSheetExitDuration = Duration(milliseconds: 200);
const Curve _modalBottomSheetCurve =
    Cubic(0.0, 0.0, 0.2, 1.0); //from curve.dart
